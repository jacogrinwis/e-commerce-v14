...
<button
    type="button"
    x-data
    class="{{ $disabled ? 'opacity-50 cursor-not-allowed' : '' }} group relative h-10 w-16 overflow-hidden rounded bg-red-600 font-medium text-white transition-all duration-300 ease-in-out hover:bg-red-400 focus:bg-green-600 focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800"
...
>
    ...
    >
        <x-icons.plus class="size-5 text-white dark:text-white" />
        <x-icons.cart class="size-5 text-white dark:text-white" />
    </span>
</button>
